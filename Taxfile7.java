...
public class Taxfile7 {
	public static class Mymapper1 extends
		...
		protected void map(LongWritable key, Text value, Context context)
			...
			if (!columns[4].equals("Nonfiler")&&!columns[2].equals("Divorced")){
				context.write(new Text("all"),new Text("count"));
			}
		}
	...
	public static class Myreducer1 extends
		...
		protected void reduce(Text key, Iterable<Text> values, Context context)
			...
			context.write(new Text("divorcedandtaxfiler"), new DoubleWritable(count));
		}
	...
	public static void main(String[] args) throws IOException,
		...
		job.setJarByClass(Taxfile1.class);
